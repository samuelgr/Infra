...
#define TEST_CASE_CONDITIONAL(name, cond)                                                          \
  ...
  {                                                                                                \
    ...
    ::Infra::Test::TestCase<kTestName__##name> testCaseInstance__##name;                           \
  }                                                                                                \
  bool ::Infra::Test::TestCase<_Infra_TestCaseInternal::kTestName__##name>::CanRun(void) const     \
  {                                                                                                \
    return (cond);                                                                                 \
  }                                                                                                \
  void ::Infra::Test::TestCase<_Infra_TestCaseInternal::kTestName__##name>::Run(void) const
