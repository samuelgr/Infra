...
rem |   Script for packaging up a release. To be executed after building the Release configuration
rem |   for all desired platforms.
rem +-----------------------------------------------------------------------------------------------
...
set version_info_dir=%cd%\Output
